...
std::string translatePL(std::string eng) {
	int i;
	std::string pLatin = "";
	eng = toLower(eng);
...
std::string SentenceTranslation(std::string sEng) {
	int i;
...
int main(int argc, const char* argv[]) {
	std::string e, p;
	std::cout << "What is the english sentence you would like translated of up to 100 characters?\n  -->  ";
	std::getline(std::cin, e);

	p = SentenceTranslation(e);
